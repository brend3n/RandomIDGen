...
#         return Ul(
#             Li(f"Name: {self.name}"),
#             Li(f"Address: {self.address}"),
#             Li(f"Email: {self.email}"),
#             Li(f"Phone: {self.phonenumber}")
#         )
...
#         Main(
#             H1("Random Identity Generator by brend3n"),
#             Button(
#                 "Randomize",
#                 hx_post="/randomize",  # Uses the input value
#                 hx_target="#name_display"
#             ),
#             P(f"{g_rid}", id="name_display", cls="")  # Displays the updated name
#         )
#     )
